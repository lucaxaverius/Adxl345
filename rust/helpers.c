...
// Helper for i2c_smbus_read_i2c_block_data
int rust_helper_i2c_smbus_read_i2c_block_data(struct i2c_client *client, int command, int length, char* values)
{
    return i2c_smbus_read_i2c_block_data(client, command, length, values);
}
EXPORT_SYMBOL_GPL(rust_helper_i2c_smbus_read_i2c_block_data);
